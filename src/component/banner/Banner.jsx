...
const Banner = () => {
    return (
        <div className='w-10/12 mx-auto py-14.5 flex flex-col lg:flex-row items-center gap-10 my-35  '>
            <div className='max-w-[700px]'>
                ...
                <h1 className='font-bold text-6xl py-5 text-[#101727] opacity-90 leading-18'>Supercharge Your Digital Workflow</h1>
